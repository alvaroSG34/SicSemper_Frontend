...
import { ParticipantMobileSidebar, ParticipantSidebar } from "./participant-sidebar";
...
export type ParticipantDashboardShellContext = {
  effectiveUserId: string;
  clearFlowState: () => void;
  handleSelectSection: (sectionId: ParticipantSectionId) => void;
};

type ParticipantDashboardShellProps = {
  activeSection: ParticipantSectionId;
  children: (context: ParticipantDashboardShellContext) => ReactNode;
};
