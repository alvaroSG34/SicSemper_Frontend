...
export function ParticipantNotificationsBell() {
  ...
  const handleNotificationClick = async (item: ParticipantNotificationItem) => {
    if (!item.isRead) {
    ...
    <div ref={containerRef} className="relative">
      ...
      {isOpen ? (
        <div
          ...
          className="fixed left-3 right-3 top-[150px] z-50 w-auto rounded-2xl border border-[#2D2D2D] bg-[#0F0F0F] p-3 shadow-[0_20px_80px_rgba(0,0,0,0.45)] md:absolute md:right-0 md:left-auto md:top-12 md:w-[360px]"
        >
